...
# Breakout Parameters
BREAKOUT_ENTRY_OFFSET_PCT = 0.0001
BREAKOUT_STOP_OFFSET_PCT = 0.0002
BREAKOUT_MAX_CANDLE_PCT = 0.007

# URL to redirect after login (required for @login_required decorator)
LOGIN_URL = '/dashboard/'

# Activate Django-Heroku.
# This automatically configures DATABASE_URL and ALLOWED_HOSTS for Heroku.
